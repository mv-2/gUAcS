...
% \end{align*}
% For a good implicit method, the 3rd order Radau IIA method is selected. This method is defined by the Butcher Tableu:
% \begin{center}
%   \begin{tabular}{c|c c}
...
%   \implies k_{n1} &= \dot{\bm{x}}_{j + \frac{1}{3}} = \left(\begin{bmatrix} 0 & c(s_{j + \frac{1}{3}}) \\ \frac{-c_{nn(j+\frac{1}{3})}}{c^2(s_{j+\frac{1}{3}})} & 0\end{bmatrix} + \frac{5}{12} k_{n1} - \frac{1}{12}k_{n2}\right)\begin{bmatrix} q_{j+\frac{1}{3}} \\ p_{j\frac{1}{3}} \end{bmatrix}\\ 
% \end{align*}
