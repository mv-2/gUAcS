...
## Pressure Field
Pressure field calculation appears somewhat reasonable although current results are completely unverified and further investigation will be undertaken.
````{python}
