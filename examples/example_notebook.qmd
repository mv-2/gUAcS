...
## Pressure Field
Calculation of the pressure field does not appear to be working correctly although it is unclear if this is an artefact of the shading or the result at this point in time.
````{python}
